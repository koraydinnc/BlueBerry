  ...
  return (
    <header className="w-full px-4 py-2 bg-white">
      <Row className="items-center justify-between">
        <Col xs={6} sm={6} md={6} className="flex justify-start cursor-pointer">
          <motion.img
            onClick={() => navigate('/')}
            src={Logo}
            alt="Logo"
        ...
        <Col xs={12} sm={6} md={6} className="flex justify-end">
         ...
         <button
  type="default"
  className="bg-cover bg-center bg-no-repeat text-white font-bold px-4 py-2 rounded-lg hover:brightness-90"
